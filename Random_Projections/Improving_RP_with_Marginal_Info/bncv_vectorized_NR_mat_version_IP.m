function [ IP_vals ] = bncv_vectorized_NR_mat_version_IP( ip_mat, vi_norm_mat, vj_norm_mat, m1_mat, m2_mat)
  ...
  while is_term > 0 && iter < max_iter
    ...
    % Update steps
    [ fx, dfx ] = bncv_vectorized_NR_mat_version_IP_fn( a_now(idx_to_go), ip_mat(idx_to_go), mimj_mat(idx_to_go), m1_mat(idx_to_go), vj_norm_mat(idx_to_go), m2_mat(idx_to_go), vi_norm_mat(idx_to_go) );       
