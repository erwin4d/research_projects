function [ fx, dfx ] = li_vectorized_IP_mle_fn( a_vec, v_IP_vec, mimj_vec, mi, norm_vj_vec, mj_vec, norm_vi )
  ...
  fx = a_vec.^3 - (a_vec.^2 .* v_IP_vec) + a_vec .* ( - mimj_vec + mi * norm_vj_vec + mj_vec * norm_vi ) - mimj_vec .* v_IP_vec;
  dfx = 3 * a_vec.^2 - 2 * (a_vec .* v_IP_vec) + ( - mimj_vec + mi * norm_vj_vec + mj_vec * norm_vi );
